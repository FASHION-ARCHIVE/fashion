    ...
    <div class = "bugreport-background">
        <div class ="br-container">
            ...
            <div class="br-members">
                ...
                <div class="br-image-item">
                    <router-link to = "/coming-soon"><img class="br-member3" data-aos="fade-up" data-aos-once="true" alt="member 3" src="@/assets/images/yy.jpeg" /></router-link>
                    <div class="caption" data-aos="fade-up" data-aos-once="true">TEAM MEMBER<br>오승민</div>
                </div>
                <div class="br-image-item">
                    <router-link to = "/coming-soon"><img class="br-member4" data-aos="fade-up" data-aos-once="true" alt="member 4" src="@/assets/images/yy.jpeg" /></router-link>
                    <div class="caption" data-aos="fade-up" data-aos-once="true">TEAM MEMBER<br>김상은</div>
                </div>
                <div class="br-image-item">
                    <router-link to = "/coming-soon"><img class="br-member5" data-aos="fade-up" data-aos-once="true" alt="member 5" src="@/assets/images/yy.jpeg" /></router-link>
                    <div class="caption" data-aos="fade-up" data-aos-once="true">TEAM MEMBER<br>유하영</div>
                </div>
                <div class="br-image-item">
                    <router-link to = "/coming-soon"><img class="br-member6" data-aos="fade-up" data-aos-once="true" alt="member 6" src="@/assets/images/yy.jpeg" /></router-link>
                    <div class="caption" data-aos="fade-up" data-aos-once="true">TEAM MEMBER<br>이주영</div>
                </div>
                <div class="br-image-item">
                    <router-link to = "/coming-soon"><img class="br-member7" data-aos="fade-up" data-aos-once="true" alt="member 7" src="@/assets/images/yy.jpeg" /></router-link>
                    <div class="caption" data-aos="fade-up" data-aos-once="true">TEAM MEMBER<br>이지현</div>
                </div>
                <div class="br-image-item">
                    <router-link to = "/coming-soon"><img class="br-member8" data-aos="fade-up" data-aos-once="true" alt="member 8" src="@/assets/images/yy.jpeg" /></router-link>
                    <div class="caption" data-aos="fade-up" data-aos-once="true">TEAM MEMBER<br>최지영</div>
                </div>
                <div class="br-image-item">
                    <router-link to = "/coming-soon"><img class="br-member9" data-aos="fade-up" data-aos-once="true" alt="member 9" src="@/assets/images/yy.jpeg" /></router-link>
                    <div class="caption" data-aos="fade-up" data-aos-once="true">TEAM MEMBER<br>유지민</div>
                </div>
                <div class="br-image-item">
                    <router-link to = "/coming-soon"><img class="br-member10" data-aos="fade-up" data-aos-once="true" alt="member 10" src="@/assets/images/yy.jpeg" /></router-link>
                    <div class="caption" data-aos="fade-up" data-aos-once="true">TEAM MEMBER<br>하나경</div>
                </div>
            </div>
        </div>
    </div>
