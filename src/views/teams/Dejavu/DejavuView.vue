        ...
        <div class ="group-container">
            <div class="team-poster-container" data-aos="fade-up" data-aos-once="true">
                ...
                <div class ="team-info-container">
                    ...
                    <div class="team-context">기억의 속삭임과 현실의 경계를 넘나들며, 순수함과 죄책감, 탄생과 소멸 등<br>반복되는 삶의 순환 속 인간의 본능을 Déjà vu로 풀어내었다. 이것은 명확히<br>인식되기도, 때로는 우리의 심연 속에서 잊혀지기도 한다.
                        <br><br>모순성의 상장인 ‘친절한 금자씨’를 뮤즈로 ‘순수의 원형’, ‘마녀의 탈을 쓴 천사’, ‘타락과 복수'라는 세 단계를 구현하였다. 후반부로 갈수록 고조되는 감정에<br>따라 깊어지는 색채와 소재를 사용하였으며 본능에서 비롯된 원초적이고 솔직한 감정을 재해석하였다.
